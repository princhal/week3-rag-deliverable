-- ============================================================
-- Reset and recreate for Gemini text-embedding-004 (768 dim)
...
-- 2. Recreate table with VECTOR(768)
...
-- 3. HNSW index for 768-dim cosine search
...
-- 4. match_chunks RPC function for 768-dim
